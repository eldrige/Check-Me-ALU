  ...
  return (
    ...
    >
      ...
      <View className="rounded-2xl py-6 bg-gray-100 mx-auto w-[90%] mt-4">
        ...
        <Text className="text-small  mt-8 mx-10">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur,
          voluptas sit vel dolore deserunt commodi alias eaque, eos suscipit
          eius dolor eveniet. Facilis voluptatem, excepturi esse impedit aliquid
          sint assumenda.
        </Text>
      </View>
    </ImageBackground>
